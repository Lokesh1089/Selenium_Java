...
public class checkbox {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//***Task: Select the languages that you know?
		//clicking on check list
		...
		//***Task: Confirm Selenium is checked
		...
		//***Task: "Select all below checkboxes"
